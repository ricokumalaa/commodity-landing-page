...
const ContactUsButton = ({ text, extraClass="", link="" }: cardsProps) => {
    ...
    return (
        <Link href={`${link}`} className={`group flex items-center gap-x-3 py-3.5 px-8 text-stone-900 bg-amber-500 rounded-sm cursor-pointer transition-all duration-300 hover:bg-amber-400 hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] active:scale-95 ${extraClass}`}>
